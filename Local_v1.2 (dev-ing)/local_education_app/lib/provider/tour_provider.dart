  ...
  Future<int> tourGetList({String keyword = ''}) async {
    try {
      ...
      if (response['statusCode'] == 200) {
        ...
        notifyListeners();
        // if (_tourList != null || _tourList!.isNotEmpty) {
        //   tourGetTourBySlug(_tourList![0].urlSlug);
        //   notifyListeners();
        //   debugPrint("This is tour detail: ${_tourDetail.toString()}");
        //   _atlas = _tourDetail?.atlas;
        //   notifyListeners();
        //   debugPrint(_atlas.toString());
        // }
        return 200;
      } else {
        return 300;
