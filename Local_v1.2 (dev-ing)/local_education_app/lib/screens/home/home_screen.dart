...
class _HomeScreenState extends State<HomeScreen> {
  ...
  _loadData() {
    ...
    Future<int> getData() async {
      final tourRes = await tourProv.tourGetTourBySlug('tourgddp10');
                      ...
                      onTap: () {
                        debugPrint("navigate to atlas page");
                         Navigator.pushNamed(context, RouteName.tourScreen,
                             arguments: TourArgument(tourSlug: 'TourGDDP'));
                        Navigator.pushNamed(context, RouteName.atlasScreen);
                      },
                      child: Container(
                        height: 250,
